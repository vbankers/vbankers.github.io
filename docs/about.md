<div class="about-header">
  <img src="assets/profile.jpg" alt="Vitto Bankers PB" class="about-avatar" width="160" height="160" loading="lazy" />
  ...
  <a href="https://github.com/vbankers" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
  ...
  <a href="mailto:vbanchieri@ethz.ch" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
